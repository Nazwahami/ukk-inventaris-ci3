...
<div class="content">
  ...
  <div class="page-header">
      <ol class="breadcrumb">
        <li>Transaksi</li>
        <li><a href="<?= base_url('pengajuan/create'); ?>">Tambah Pengajuan</a></li>
      </ol>

    <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="<?= base_url('pengajuan'); ?>" class="btn btn-light">Kembali</a>
        <a href="<?= base_url('pengajuan/create'); ?>" class="btn btn-light"><i class="fa fa-refresh"></i></a>
      </div>
    </div>
